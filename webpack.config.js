...
const setPublicPath = () => {
  let env = NODE_ENV;
  if (env === 'production') {
    return 'https://coracain.top/vue-element-placeholder-polyfill/';
  }
  return '/';
}

const extractHTML = new HtmlWebpackPlugin({
  title: 'vue-element-placeholder-polyfill',
  filename: 'index.html',
  inject: true,
...
const config = {
  ...
  output: {
    ...
    library: 'inputie9Mixins',
    libraryTarget: 'umd',
    filename: 'js/vue-element-placeholder-polyfill.min.js' 
  },
  resolveLoader: {
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: 'css/vue-element-placeholder-polyfill.min.css',
